...
declare
  ...
  v_count int;
begin
  -- tomar la ultima reserva activa de Paula
  ...
  -- expirar esa reserva (puede haber mas de una activa por bug previo; expiramos todas para ese inventory_id)
  ...
  -- devolver stock por la cantidad expirada
